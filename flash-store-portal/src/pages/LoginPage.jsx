...
export default function LoginPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      // Admin Platform Phase 3 — a temporary/seeded password must be
      // changed before landing anywhere else (ProtectedRoute enforces this
      // on every subsequent navigation too; this just avoids one extra
      // redirect bounce on the very first landing).
