...
- [ ] H-1: still open — a real decision, not a mechanical fix (lower the threshold honestly + ratchet up, vs. write substantial new tests for the state machine/socket auth paths, both still near 0%). Bringing this to the founder as a trade-off rather than deciding unilaterally, per engagement rules.
