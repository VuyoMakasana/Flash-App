...
export default function HomeScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Storefront port — real, always-visible entry point to the store
          directory. Deliberately not gated behind stores.length > 1 below:
          the directory itself is useful and testable even at exactly one
          real store. */}
