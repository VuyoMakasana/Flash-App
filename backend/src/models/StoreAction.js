...
// Store-scoped audit log (docs/audits/FLASH_STORE_ADMIN_DESIGN.md §5.4) — the
// store-portal equivalent of AdminAction, structurally separate from
...
// directly, so a future dispute ("did this Store Manager touch an order that
// wasn't theirs") is answerable from the log itself, not just the actor.
