...
export default function OrdersPage() {
  ...
  // Admin Platform Phase 3 — "stores receive their own orders in real-time"
  // (a new order reaching pending_store_acceptance, or any status change on
  // one already in the list) instead of only ever finding out on the next
  // manual page load.
  useStoreSocket(loadOrders);
